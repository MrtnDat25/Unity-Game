...
public class BossEnemy : Enemy
{
    ...
    [SerializeField] private float speedDanVongTrong = 10f;
    ...
    private void BanDanVongTron()
    {
        ...
        for( int i = 0; i < bulletCount; i++ )
        {
            ...
            EnemyBullet enemyBullet=bullet.AddComponent<EnemyBullet>();
            enemyBullet.SetMovementDirection(bulletDirection * speedDanVongTrong);
        }
    }
    private void HoiMau(float hpAmmount)
    {
